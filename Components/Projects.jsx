...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      desc: "Poke-memo was my first project using the React. It is a memory-based game about correctly recognizing and memorizing the pokemon you have already selected before. If you 'Catch-em-all!!', you win the game. It is a basic demonstration of how React can make repetitive components easy with the integration of javascript and html in one place"
    },
    {
      name: "Coming Soon",
      link: "#",
